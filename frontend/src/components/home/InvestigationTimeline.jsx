...
const TIMELINE_EVENTS = [
  ...
  {
    id: 'd2-04', caseNo: 'EVID-011', day: 'Day 2', time: '13:00',
    title: 'PROMPT SPRINT',
    status: 'AI CHALLENGE', statusColor: '#a855f7', pinColor: '#a855f7',
    stickyColor: 'pink', suspectLabel: 'PROMPT ENGINEERS',
    stickyLines: ['TOOLS: AI', 'SPEED: CRITICAL'],
    description: 'A fast-paced prompt engineering competition — use Generative AI to solve logic and debugging challenges.',
  ...
  {
    id: 'd3-09', caseNo: 'EVID-022', day: 'Day 3', time: '17:30',
